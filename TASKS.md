...
- [ ] Still deferred: design consistency pass (old-palette modals), shared item-action-row extraction, dead `clever-endpoint` edge function (needs Dashboard deletion), migrations-not-in-git gap.
